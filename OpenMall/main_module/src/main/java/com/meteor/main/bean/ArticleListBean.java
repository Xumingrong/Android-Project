...
public class ArticleListBean implements Serializable {
    ...
    public static class DatasBean implements Serializable {
         ...
         * origin :
         * projectLink :
         * publishTime : 1524450097000
         * superChapterId : 349
         * superChapterName : 开放API
         * tags : []
         * title : 开源中国oschina API
         * type : 0
         * visible : 1
         * zan : 0
         */
